...
console.log("Shumaila" as string === "Shalom");    //false
...
console.log("Hadi"as string === "Abishay" || "Rayyan" as string=== "Rahman");   //false  

//---------- Test whether an item is in a array---------------
let friend : string[] = ["Nazish","Asma","Ameera","Ayesha"]
...
//-------------Tests using "or" operators---------------------
console.log("Apple" as string=== "Grapes" || 100 as number === 110);    //false
